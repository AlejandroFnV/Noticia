...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 text-center">
					<h1 id="fh5co-logo"><a href="{{ route('frontend.main') }}">Magazine <sup>TM</sup></a></h1>
				</div>
	...
	<div class="container-fluid">
		<div class="row fh5co-post-entry single-entry">
			<article class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0">
				<span class="fh5co-meta animate-box"><a href="{{ url('single/autor/' . $noticia->autor) }}">{{ $noticia->autor }}</a></span>
				...
				<div class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-left content-article">
					<div class="row">
						<div class="col-lg-12 cp-r animate-box">
							<h2>{{ $noticia->textoNoticia }}</h2>
						</div>
					</div>
					
					<!--COMENTARIOS-->
					<h3 class="animate-box">Comentarios</h3>
					@foreach($comentarios as $comentario)
					<div class="row rp-b">
						<div class="col-md-12 animate-box">
							<blockquote>
								<p>&ldquo;{{ $comentario->textoComentario }} &rdquo; <cite>&mdash; {{ $comentario->correo }}</cite></p>
							</blockquote>
						</div>
					</div>
					@endforeach
	...
	<!--HACER COMENTARIO-->
	<h3 class="heading">Comentario</h3>
	<form action="{{ url('single/' . $noticia->id . '/comentario') }}" method="post">
		@csrf
		...
		<div class="form-group">
			<input type="text" name="textoComentario" class="form-control" placeholder="Comentario">
