  ...
  <!-- 
	...
	<div id="fh5co-offcanvas">
		...
		<div class="fh5co-bio">
			...
			<h2>Alejandro Fernández Valdivia</h2>
	...
	<div class="container-fluid">
		<div class="row fh5co-post-entry">
			...
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="{{ url('single/' . $noticia->id) }}"><img src="images/pic_1.jpg" alt="Image" class="img-responsive"></a>
				</figure>
				<span class="fh5co-meta"><a href="{{ url('single/' . $noticia->id) }}">{{ $noticia->autor }}</a></span>
				<h2 class="fh5co-article-title"><a href="{{ url('single/' . $noticia->id) }}">{{ $noticia->titulo }}</a></h2>
