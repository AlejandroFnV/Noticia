...
<head>
  ...
  <title>Backend de Noticias | Dashboard</title>
  @yield('prestyle')
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- SEARCH FORM -->
    <form action="{{ route('backend.noticia.paginate.index') }}" class="form-inline ml-3">
      <div class="input-group input-group-sm">
        <input class="form-control form-control-navbar" name="search" value="{{$search ?? ''}}"  type="search" placeholder="Noticias" aria-label="Search">
    ...
    <!-- SEARCH FORM -->
    <form action="{{ route('backend.comentario.paginate.index') }}" class="form-inline ml-3">
      <div class="input-group input-group-sm">
        <input class="form-control form-control-navbar" name="search" value="{{$search ?? ''}}"  type="search" placeholder="Comentarios" aria-label="Search">
        <div class="input-group-append">
          <button class="btn btn-navbar" type="submit">
            <i class="fas fa-search"></i>
          </button>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Aplicación de Noticias</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
